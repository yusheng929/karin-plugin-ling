...
export const 续火 = karin.task("续火", Config.Cof.corn || "0 0 * * *", async (e: { bot: { SendMessage: (arg0: Contact<"group" | "friend" | "guild" | "guild_direct" | "nearby" | "stranger" | "stranger_from_group">, arg1: any[]) => any } }) => {
