 ...
 * @returns 是否继续处理
 */
const updateCfg = async (e: { reply: (arg0: string, arg1: { at: boolean } | undefined) => void }, type: string, isRemoval: any, targetType: string, id: any) => {
  try {
...
const UpdateFile = async (e: { reply: (arg0: string) => void }, 文件: any, 修改的值: string | number | boolean | object | any[], 配置项: string, 修改内容: any) => {
  try {
