...
let loader: { App: any; task: any } | null = null
export default function otherInfo (e: any) {
  const otherInfo = []
  // 其他信息
  otherInfo.push({
    first: '系统',
...
function getPluginNum (e: { isPro: any }) {
...
function formatDuration (seconds: moment.DurationInputArg1, p0: string, p1: boolean) {
