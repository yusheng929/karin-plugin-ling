...
async function getMessageCount (bot: { stat: { sent_msg_cnt: any; recv_msg_cnt: any } }) {
...
async function getCountContacts (bot: { GetFriendList: () => any; fl: { size: any }; GetGroupList: () => any; gl: { size: any }; gml: any[] }) {
  let friend = 0
  let group = 0
  try {
