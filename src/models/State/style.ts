...
function arrayBufferToBase64 (arrayBuffer: WithImplicitCoercion<ArrayBuffer | SharedArrayBuffer>) {
  return Buffer.from(arrayBuffer).toString('base64')
}
function getDefaultBackdrop (backdropDefault: string | undefined) {
