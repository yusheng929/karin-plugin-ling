...
export let si: any = null
export let osInfo: any = null
export let colorthief: any = null
/**
 * 异步初始化系统信息依赖
...
export async function getImgColor (path: any) {
  importColorThief()
...
export async function getImgPalette (path: string) {
 ...
 */
export function getFileSize (size: number | null | undefined, { decimalPlaces = 2, showByte = true, showSuffix = true } = {}) {
...
export async function createAbortCont (timeoutMs: number | undefined) {
  let AbortController
